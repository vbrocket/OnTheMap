...
class ParseClient : NSObject {
    //static var studentLocationArray: [StudentInformation] = []
    ...
    var user_firstname: String? = nil
    var user_lastname: String? = nil
    ...
    func taskForPOSTMethod(method: String, var parameters: [String:AnyObject], jsonBody: String, completionHandlerForPOST: (result: AnyObject!, error: NSError?) -> Void) -> NSURLSessionDataTask {
        ...
        /* 2/3. Build the URL, Configure the request */
        //let request = NSMutableURLRequest(URL: parseURLFromParameters(parameters, withPathExtension: method))
        let request = NSMutableURLRequest(URL: NSURL(string: "https://api.parse.com/1/classes/StudentLocation")!);        request.HTTPMethod = "POST"
        ...
        print(jsonBody)
        print("-----------------------------")
        request.HTTPBody = jsonBody.dataUsingEncoding(NSUTF8StringEncoding)//.dataUsingEncoding(NSUTF8StringEncoding)
